...
- (void)startWithMelbourneTime:(BOOL)showMelbourneTime
{
    isShowMelbourneTime = showMelbourneTime;
...
- (void) updateClock:(NSTimer *)theTimer
{
    ...
    if(isShowMelbourneTime)
    {
        dateComponents = [[NSCalendar currentCalendar] components:(NSHourCalendarUnit | NSMinuteCalendarUnit | NSSecondCalendarUnit) fromDate:[self getLocalDateFromGMTDate:[NSDate date]]];
    }
    else
    {
...
-(NSDate *)getLocalDateFromGMTDate:(NSDate *)dt
{
    NSDate *date = dt;
    
    NSTimeZone *currentTimeZone = [NSTimeZone localTimeZone];
    NSTimeZone *utcTimeZone = [NSTimeZone timeZoneWithName:@"Australia/Melbourne"];
